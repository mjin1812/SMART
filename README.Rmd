...
![**Region plot**](C:/Users/mjin1/Documents/GitHub/ezBrain/schematics/dotplot.PNG){width=70%}

</center>

<a id="id14"></a> 
**`ez_sunburst()`** Generate a sunburst plot using a forward warped dataset. 
...
```
> Note: this dataframe may be useful for generating other heirarchical plots with the dataset such as [treemaps](https://github.com/cran/treemap).

\newpage
<a id="id16"></a> 
**`ez_glassbrain()` ** A modified version of wholebrain::glassbrain(). New options include:
...
> Tip: Combine the `get_rois()` function output with `ez_glassbrain()` to get a glass brain of just ROIs.
