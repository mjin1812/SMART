...
+ [`ez_sunburst()`](#id14) Generates a sunburst plot using a forward warped dataset.
+ [`get_tree()`](#id15) Creates a dataframe of hierarchical region cell count data.
+ [`ez_glassbrain()`](#id16) Generates a 3D plot of cells counts with option of removing glassbrain in the background.
...
![**Brainmorph plot**](C:/Users/mjin1/Documents/GitHub/ezBrain/schematics/brainmorph.PNG){width=40%}
...
**`ez_regi()`** Provides a user friendly interface to alter registrations. It
...
Below are representative forward warp and schematic images:
  ...
  **Forward warp image**
  ...
  ![](C:/Users/mjin1/Documents/GitHub/ezBrain/schematics/forwardwarp.PNG){width=75%}

**Schematic plot**
  
  ![](C:/Users/mjin1/Documents/GitHub/ezBrain/schematics/schematic.PNG){width=40%}
