...
images of remaining atlas plates. They were chosen because: 1) Based on our
experience, they contain easy internal region landmarks that can be consistently
identified by different users and 2) They are somewhat evenly spaced throughout
the brain. However, these coordinates are user modifiable to account for user
preference and varying AP ranges of imaging datasets.

If you are using this pipeline for the first time, I recommend you take the default values. 
...
# There will be user walk through for 'separator' 
...
**`ez_savepaths()`**  User friendly way to create standardized save directories based on the setup information from `setup_pl()`. Returns a list of savepaths to subfolders in the output folder.
...
The middlemost window (choice 2) is ezBrain's best guess at the z images best
...
![**Display and prompt**](C:/Users/mjin1/Documents/GitHub/ezBrain/schematics/choice_game_1.PNG){width=65%}
...
![**Midpoint quality check display**](C:/Users/mjin1/Documents/GitHub/ezBrain/schematics/choice_game_2.PNG){width=40%}
...
> setup$regi_AP
 [1]  2.31064885  2.20950382  2.10835878  2.00721374  1.90606870  1.80492366  1.70377863  1.60263359  1.50148855
[10]  1.40034351  1.29919847  1.19805344  1.09690840  0.99576336  0.89461832  0.79347328  0.69232824  0.59118321
[19]  0.49003817  0.38889313  0.28774809  0.18660305  0.08545802 -0.01568702 -0.11683206 -0.21797710 -0.31912214
[28] -0.42026718 -0.52141221 -0.62255725 -0.72370229 -0.82484733 -0.92599237 -1.02713740 -1.12828244 -1.22942748
[37] -1.33057252 -1.43171756 -1.53286260 -1.63400763 -1.73515267 -1.83629771 -1.93744275 -2.03858779 -2.03858779
[46] -2.13973282 -2.24087786 -2.34202290 -2.44316794 -2.54431298 -2.64545802 -2.74660305 -2.84774809 -2.94889313
[55] -3.05003817 -3.15118321 -3.25232824 -3.35347328 -3.45461832 -3.55576336 -3.65690840 -3.75805344 -3.85919847
[64] -3.96034351 -4.06148855 -4.16263359 -4.26377863 -4.36492366 -4.46606870 -4.56721374 -4.66835878

> setup$regi_z
 [1]   45   88  132  175  219  265  311  358  404  450  497  544  590  614  638  662  685  709  733  757  781  834
[23]  888  941  995 1048 1102 1155 1179 1202 1226 1249 1273 1315 1356 1398 1439 1481 1523 1564 1606 1647 1689 1730
[45] 1730 1770 1811 1852 1893 1933 1974 2015 2055 2096 2134 2171 2209 2246 2284 2322 2359 2397 2434 2472 2497 2522
[67] 2547 2573 2598 2623 2648
...
across the brain in either the registration or segmentation channel. The `wholebrain::segment()` 
function is used to display the segmentation output. The user can change filter parameters after exiting out of every.
